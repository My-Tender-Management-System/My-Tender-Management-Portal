...
import {EventServiceForDashboard} from '../service/eventservice';
import {PrimeIcons} from 'primeng/api';
import {Customer} from '../domain/customer';
import {CustomerServiceForDashboard} from '../service/customerservice';
...
export class DashboardDemoComponent implements OnInit, OnDestroy {
    ...
    // this has begin
    tenderCount: number = 10;
    companyCount: number = 50;
    equipmentCount: number = 100;
    ...
    constructor(private customerService: CustomerServiceForDashboard, private eventService: EventServiceForDashboard, private breadcrumbService: AppBreadcrumbService, public configService: ConfigService) {
    ...
    ngOnInit() {
        ...
        this.primary700 = getComputedStyle(document.body).getPropertyValue('--primary-700').trim();
        this.primary400 = getComputedStyle(document.body).getPropertyValue('--primary-400').trim();
        this.primary100 = getComputedStyle(document.body).getPropertyValue('--primary-100').trim();
            ...
            datasets: [
                {
                    ...
                    backgroundColor: getComputedStyle(document.body).getPropertyValue('--primary-700'),
            ...
            datasets: [
                {
                    data: [300, 50, 100],
                    backgroundColor: [
                        getComputedStyle(document.body).getPropertyValue('--primary-700'),
                        getComputedStyle(document.body).getPropertyValue('--primary-400'),
                    ...
                    hoverBackgroundColor: [
                        getComputedStyle(document.body).getPropertyValue('--primary-600'),
                        getComputedStyle(document.body).getPropertyValue('--primary-300'),
                        getComputedStyle(document.body).getPropertyValue('--primary-200'),
                        '#EEE500',
                        '#FC6161',
                        '#00D0DE',
                        '#873EFE',
